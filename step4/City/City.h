...
public:
	...
	void Accept1(CTileVisitor *visitor);
	...
	/** Sets the Run Away flag
	 * \param isRunning bool that determines state of flag */
	void SetRunAway(bool isRunning) { mRunAway = isRunning; }

	/** Gets condition of RunAway
	 * \returns RunAway bool that tells flag state */
	bool GetRunAway() { return mRunAway; }

	/** Sets the New Season flag
	 * \param NewSeason bool that determines state of flag */
	void SetNewSeason(bool isNewSeason) { mNewSeason = isNewSeason; }

	/** Gets condition of NewSeason
	 * \returns NewSeason bool that tells flag state */
	bool GetNewSeason() { return mNewSeason; }
private:
	...
	/// If Run Away is clicked then true
	bool mRunAway = false;

	/// If New Season is clicked then tru
	bool mNewSeason = false;
};
