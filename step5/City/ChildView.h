...
private:
	...
	bool mIsPlay = false;   ///< Set true when play is clicked

	bool mShowHistory = false;	///< Set true when Mouse Tracks is clicked
public:
	...
	afx_msg void OnUpdateBigtenRunaway(CCmdUI *pCmdUI);
	afx_msg void OnBigtenRunaway();
